...
// 执行SQL语句
$sql="select 学号,班号,姓名,照片,性别,出生日期,电话 from student where 学号='{$kid}'";
		...
		<form action="student-save.php" id="form1"  class="sui-form form-horizontal sui-validate" method="post" enctype="multipart/form-data">
			<div class="control-group">
				...
				<div class="controls">
				    ...
				    <input type="text" id="banhao" class="input-large input-fat" placeholder="输入学号" data-rules="required|minlength=2|maxlength=10" name="xsid" value="<?php echo $row['学号']; ?>">
				</div>
			</div>
			<div class="control-group">
