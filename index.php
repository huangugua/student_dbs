<?php include "head_01.php"; ?>
  		<form action="register-save.php" class="sui-form form-horizontal sui-validate" id="formf" method="post">
  			...
  			<div class="control-group">
    			...
    			<div class="controls">
      				<input type="text" id="name" name="name" class="input-large input-xfat" placeholder="请输入用户名" data-rules="required|minlength=2|maxlength=6">
    			</div>
  			</div>
  			<div class="control-group">
...
<script>
 var email = document.getElementById('email');
  ...
  $("input[name=submit]").on("click",function(){
    ...
    xhr.send("email="+email.value+"&name="+name.value+"&password="+password.value+"&question="+question.value+"&answer="+answer.value);
  })
</script>